...
const App = () => {
  const dummyData = [
    ...
    },
    {
      ...
      title: "React Course",
      description:
        "Unlock the full potential of modern web development with our comprehensive React JS and Redux course! Dive into the world of cutting-edge technology by mastering React, the most popular JavaScript library for creating dynamic user interfaces, and Redux, the robust state management tool that ensures your applications run seamlessly.",
      Image: "react.png",
    },
    ...
    },
    {
      ...
      title: " C++ course",
      description:
        "This is the best  C++ Course PlayList Master the fundamentals of algorithmic thinking and problem-solving  C++ Course! This course is meticulously designed to help you build a strong foundation in data structures and algorithms using C++, one of the most powerful and versatile programming languages.",
      Image: "cpp.png",
    },
    {
      id: 6,
